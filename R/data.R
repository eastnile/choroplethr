...
#' A data.frame containing population estimates for all Census Tracts in New York 
#' State in 2012.   
#'
...
#' 
#' @name df_congress_116_demographics
#' @docType data
#' @references Data comes from the 2018 5-year American Community Survey (ACS). Data generated by
#' ?get_congressional_district_demographics 
#' @keywords data
#' @usage data(df_congress_116_demographics)
NULL
